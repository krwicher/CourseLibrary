...
namespace CourseLibrary.API.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        [HttpPut("{courseId}")]
        public IActionResult UpdateCourseForAuthor(Guid authorId, Guid courseId, CourseForUpdateDto updateDto)
        {
            if (!_courseLibraryRepository.AuthorExists(authorId))
                return NotFound();
            ...
            if (courseForAuthorFromRepo == null)
            {
                var courseToAdd = _mapper.Map<Course>(updateDto);
            ...
            _mapper.Map(updateDto, courseForAuthorFromRepo);
